...
class PropositionOffre extends StatefulWidget {
  const PropositionOffre({Key? key}) : super(key: key);

  @override
  State<PropositionOffre> createState() => _PropositionOffreState();
}

class _PropositionOffreState extends State<PropositionOffre> {
  @override
